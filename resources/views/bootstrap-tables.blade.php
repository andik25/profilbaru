      ...
      <div class="py-4">
          ...
          <div class="d-flex justify-content-between w-100 flex-wrap">
              <div class="mb-3 mb-lg-0">
                  <h1 class="h4">Tabel 21</h1>
                  <p class="mb-0">Angka Kehaliran Menurut Jenis Kelamin</p>
              </div>
              <div>
              ...
              <div class="table-responsive">
                  <table class="table table-centered table-nowrap mb-0 rounded">
                      <thead class="thead-light">
                          <tr>
                              <th rowspan="2" class="border-1 rounded-start">#</th>
                              <th colspan="6" style="text-align: center">semua</th>
                          </tr>
                          <tr>
                              <th class="border-1">Traffic Source</th>
                              <th class="border-1">Source Type</th>
                              <th class="border-1">Category</th>
                              <th class="border-1">Global Rank</th>
                              <th class="border-1">Traffic Share</th>
                              <th class="border-1 rounded-end">Change</th>
                          </tr>
