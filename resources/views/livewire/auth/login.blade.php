<main>
    <title>Login :: Datinkes KabProb</title>
    <!-- Section -->
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0"> SATU DATA KESEHATAN 
                                    <strong>KAB PROBOLINGGO</strong></p>
                        ...
                        <form class="mt-4">
                            ...
                            <div class="d-grid">
                                <button type="button" class="btn btn-gray-800" wire:click="login">Masuk</button>
                            </div>
                        </form>
                        <div class="mt-3 mb-4 text-center">
                            <span class="fw-normal">Sosial Media kami</span>
                        </div>
