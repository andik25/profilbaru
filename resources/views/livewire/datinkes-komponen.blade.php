<div>
    <title>Komponen - Datinkes KabProb</title>
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Komponen Kesehatan</h1>
            </div>
        </div>
    </div>
    {{-- Modal ganti bulan --}}
            ...
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            {{-- <th class="border-0 rounded-start">Nama Komponen</th> --}}
                    ...
                    <tbody>
                        ...
                        <div class="container">
                            <div class="row g-2 text-center">
                                @foreach ($komponen as $m)
                                    <div class="col-md-2 col-6">
                                        <div class="col-12 col-md-12 p-1 bg-custom rounded">
                                            <div class="menu-title">{{ $m->nama_komponen }}</div>
                                            <a href="/datinkes/{{ $program->id }}/{{ $m->id }}">
                                                <div class="menu-card bg-white">
                                                    <i class="bi bi-alarm-fill menu-icon" data-percent="75"></i>
                                                </div>
                                            </a>
                        ...
                        {{-- @foreach ($komponen as $m)
                            <tr>
                                <td>{{ $m->nama_komponen }}</td>

                                <td>
                                    <a class="btn badge bg-warning text-dark"
                                        href="/datinkes/{{ $program->id }}/{{ $m->id }}">Detail</a>
                                </td>
                            </tr>
                        @endforeach --}}
                    </tbody>
