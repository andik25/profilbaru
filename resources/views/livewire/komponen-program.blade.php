<div>
    <title>Pengaturan Komponen - Datinkes KabProb</title>
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('komponen-program', ['kom' => $komponen->id]) }}">{{ $komponen->nama_program }}</a>
                </li>
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">{{ $komponen->nama_program }}</h1>
                <p class="mb-0">Komponen Program</p>
            </div>
            <div>
                {{-- Modal Tambah Kategori Indikator --}}
                <button type="button" class="btn btn-sm btn-block btn-primary mb-3" data-bs-toggle="modal"
                    data-bs-target="#modal-default">Tambah Komponen Program</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control @error('nama_komponen')
                                        is-invalid
                                    @enderror"
                                        wire:model="nama_komponen">
                                    @error('nama_komponen')
                ...
                <div wire:ignore.self class="modal fade" id="modal-update" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Kategori Indikator</label>
                                    <input type="text"
                                        class="form-control @error('id_kategori_indikator')
                                        is-invalid
                                    @enderror"
                                        wire:model="id_kategori_indikator">
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0 rounded-end">Nama Komponen Program</th>
                        ...
                        @foreach ($kom as $m)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('maskat', ['kom' => $komponen->id, 'komp' => $m->id]) }}"
                        ...
                        @if ($komponenToDeleteId !== null)
                            <div
                                ...
                                <div
                                    ...
                                    <p>Apakah Anda yakin ingin menghapus <strong>{{ $komponenToDeleteName }}</strong>?
                                    </p>
                                    <div
